...
const container = El({
  element: "div",
  className:
    "flex flex-col h-screen w-auto bg-cover bg-center text-white p-4 relative",
  restAttrs: {
    style:
      "background-image:linear-gradient(rgba(0, 0, 0, .5), rgba(0, 0, 0, 0.5)), url('images/wallpaper.png');",
  },
});
...
const overlay = El({
  element: "div",
  className:
    "flex flex-col h-auto w-auto  bg-opacity-100 absolute bottom-36 gap-4",
});
